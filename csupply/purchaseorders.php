...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h2 id="modalTitle" class="modal-title">Create Purchase Order</h2>
    </div>
    ...
    <div class="modal-body">
        ...
        <input type="hidden" id="stockroom" value="">
        <input type="hidden" id="supplier" value="">
        
        
        <label for="select_stockroom" class="form-label">Stockroom</label>
            <select class="form-select" id="select_stockroom" onchange="getStockroomName(this)"  aria-describedby="Stockroom select">
   ...
   <h1 id="selectedSR"></h1>
        ...
        <label for="select_supplier" class="form-label">Supplier</label>
            <select class="form-select" id="select_supplier" onchange="getSupplerName(this)" aria-describedby="Supplier select">
                <option  value="" disabled selected>Select Supplier</option>
                <?php echo $output_supplier;?>  
            </select>
   <br>
   <h1 id="selectedSupplier"></h1>   
    ...
    <div class="modal-footer">
        <input type="button" id="manageBtn" onclick="manageData('addNew')" value="Create PO" class="btn btn-success">
    </div>
    ...
    <input style="float: right;" type="button" id="addNew" class="btn btn-success" value="Create New PO"><br>
