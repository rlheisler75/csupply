...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h2 id="modalTitle" class="modal-title">Suppliers</h2>
    </div>
    ...
    <div class="modal-body">
        ...
        <input type="text" class="form-control" id="account" placeholder="Account Number"><br>
        <label for="supplier">Supplier Name</label>
        <input type="text" class="form-control" id="supplier" placeholder="Supplier Name"><br>
        <label for="contact_first_name">Contact First Name</label>
        <input type="text" class="form-control" id="contact_first_name" placeholder="First Name"><br>
        <label for="contact_last_name">Contact Last Name</label>
        <input type="text" class="form-control" id="contact_last_name" placeholder="Last Name"><br>
        <label for="email">Contact Email</label>
        <input type="text" class="form-control" id="email" placeholder="name@domain.com"><br>
        <label for="phone"> Contact Phone Number</label>
        <input type="text" class="form-control" id="phone" placeholder="555-555-5555"><br>
        <label for="corp_phone">Corporate Phone Number</label>
        <input type="text" class="form-control" id="corp_phone" placeholder="555-555-5555"><br>
        <label for="street_address">street_address</label>
        <input type="text" class="form-control" id="street_address" placeholder="123 N Main St."><br>
        <label for="street_address_line_2">Street Address Line 2</label>
        <input type="text" class="form-control" id="street_address_line_2" placeholder="suite 101"><br>
        <label for="city">City</label>
        <input type="text" class="form-control" id="city" placeholder="Smailville"><br>
        <label for="state">State / Province</label>
        <input type="text" class="form-control" id="state" placeholder="Kansas"><br>
        <label for="postal">Postal / Zip Code</label>
        <input type="text" class="form-control" id="postal" placeholder="Zip/Postal"><br>
    ...
    <div class="modal-footer">
        <input type="button" id="manageBtn" onclick="manageData('addNew')" value="Add Supplier" class="btn btn-success">
    </div>
    ...
    <table id="supplierTable" class="table table-hover table-border">
        <thead>
            <tr>
                <td>Account</td>
                <td>Supplier Name</td>
