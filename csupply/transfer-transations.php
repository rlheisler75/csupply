...
<head>
  <meta charset="utf-8" />
        ...
        <title>Transfer Transations</title>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker.min.css">
     ...
     <!-- Navbar-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseReports" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="transfer-transations.php">Transfer Transations</a>
      ...
      <div class="container-fluid px-4">
                        <h1 class="mt-4">Transfer Transations</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">transfer-transations</li>
                        </ol>
...
<script src="../js/transfer_transactions_script.js"></script>
  </body>
</html>