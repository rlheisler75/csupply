                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="stockroom.php">
...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h2 id="modalTitle" class="modal-title">Stockroom</h2>
    </div>
    ...
    <div class="modal-body">
        ...
        <input type="text" class="form-control" id="stockroom" placeholder="Stockroom Name"><br>
        <label for="description">Description</label>
        <input type="text" class="form-control" id="description" placeholder="Short Description"><br>
    ...
    <div class="modal-footer">
        <input type="button" id="manageBtn" onclick="manageData('addNew')" value="Add Stockroom" class="btn btn-success">
    </div>
...
<script src="../js/stockroom_script.js"></script>
