        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="uom.php">UOM</a>
                                </nav>
                            </div>
                        </div>
                    </div>
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Unit of Measurement (UOM) Codes</h1>
...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h2 id="modalTitle" class="modal-title">UOM</h2>
    </div>
    ...
    <div class="modal-body">
        ...
        <label for="uom">UOM Abrviation </label>
        <input type="text" class="form-control" id="uom" placeholder="UOM"><br>
    ...
    <div class="modal-footer">
        <input type="button" id="manageBtn" onclick="manageData('addNew')" value="Add UOM" class="btn btn-success">
    </div>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs5/jszip-2.5.0/dt-1.11.5/b-2.2.2/b-html5-2.2.2/b-print-2.2.2/r-2.2.9/datatables.min.js"></script>
    ...
    <script src="../js/uom_script.js"></script>
  </body>
</html>