...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h2 id="modalTitle" class="modal-title">Category</h2>
    </div>
    ...
    <div class="modal-body">
        ...
        <input type="text" class="form-control" id="category" placeholder="category"><br>
    ...
    <div class="modal-footer">
        <input type="button" id="manageBtn" onclick="manageData('addNew')" value="Add category" class="btn btn-success">
    </div>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs5/jszip-2.5.0/dt-1.11.5/b-2.2.2/b-html5-2.2.2/b-print-2.2.2/r-2.2.9/datatables.min.js"></script>
    ...
    <script src="../js/categories_script.js"></script>
    <!--check this -->
