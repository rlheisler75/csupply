...
<?php include 'php/get_uom.php';?>
    ...
    <?php include 'php/get_stockroom_data.php';?>
  <meta charset="utf-8" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
        <meta name="description" content="" />
        <meta name="author" content="" />
        <title><?php echo $stock_room_name;?></title>
...
<h1> <?php echo $stock_room_name;?></h1>
...
<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <input type="hidden" id="stockroom_id" value="<?php echo $id;?>">
        ...
        <input type="text" class="form-control" id="category" placeholder="Category Name" readonly ><br>
        
        <label for="supplier">Supplier</label>
        <input type="text" class="form-control" id="supplier" placeholder="Supplier Name" readonly ><br>
        ...
        <input type="number" min="1" class="form-control" id="cost" placeholder="cost" readonly><br>

        <label for="orderUOM">Order Unit of measurement</label>
        <input type="text" class="form-control" id="orderUOM" placeholder="Unit of measurement the produt is oreder in" readonly><br>
        ...
        <label for="issueUOM">Unit of measurement the produt is Issued in</label>
        <input type="text" class="form-control" id="issueUOM" placeholder="Unit of measurement the produt is Issued in" readonly><br>
        
        <label for="price">Price</label>
        <input type="number" min="1" class="form-control" id="price" placeholder="Price" readonly><br>

        <label for="parLevel">Par Level<span class="text-danger">*</span></label>
        <input type="number" min="0" class="form-control" id="parLevel" aria-label="Par Level" required >

      

        <label for="onHand">On Hand<span class="text-danger">*</span></label>
        <input type="number" min="0" class="form-control" id="onHand" aria-label="On Hand" required >
